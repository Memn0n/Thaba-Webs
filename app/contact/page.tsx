...
const page = () => {
  return (
    <div className='mx-2 sm:mx-10 mb-20'>
      <h1 className='text-4xl text-gray-400 text-center font-semibold mt-10'>
        Contact Us
      </h1>
        ...
        <div>
          ...
          <div className='flex gap-10 mb-8'>
            ...
            <p className='text-xl font-medium'>
              littlefallsguesthouse@gmail.com
            </p>
          </div>
          ...
          <Link href='https://www.instagram.com/little_falls_guest_house/'>
            <div className='flex gap-10 mb-8'>
              ...
              <p className='text-xl font-medium'>@little_falls_guest_house</p>
            </div>
          </Link>
