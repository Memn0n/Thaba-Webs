...
const Ecommerce = () => {
  return (
    <div>
      ...
      <h1 className='pt-2 text-center text-2xl drop-shadow-l font-semibold pb-4'>E-Commerce Websites</h1>
      <ol type='i' className='mx-10'>
        ...
        <li className='text-xl pb-1 font-normal'>- Double Project <br/>&nbsp;&nbsp;(Store & Admin)</li>
        <li className='text-xl pb-1 font-normal'>- Admin & Customer &nbsp;&nbsp;Sign-up/Sign-in</li>
        <li className='text-xl pb-1 font-normal'>- Dynamic Content</li>
        <li className='text-xl pb-1 font-normal'>- Newsletter Function</li>
        <li className='text-xl pb-1 font-normal'>- FullStack</li>
        <li className='text-xl pb-1 font-normal'>- Free Logo</li>
        <li className='text-xl pb-1 font-normal'>- 2 Free Update</li>
      </ol>
